...
wget -q https://github.com/Kitware/CMake/releases/download/v$CMAKE_VERSION/$CMAKE_DOWNLOAD_PACKAGE.tar.gz &&
...
wget -q https://github.com/llvm/llvm-project/releases/download/llvmorg-$LLVM_VERSION/$LLVM_DOWNLOAD_PACKAGE.tar.xz &&
...
wget -q https://dl.google.com/android/repository/$NDK_DOWNLOAD_PACKAGE.zip &&
